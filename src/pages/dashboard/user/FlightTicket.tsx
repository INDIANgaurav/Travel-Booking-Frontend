    ...
    <>
      ...
      <div className="w-full max-w-5xl flex justify-between items-center mb-8 mt-2 print:hidden">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <Printer size={18} />
            Print {booking.type === 'HOTEL' ? 'Voucher' : 'E-Ticket'}
          </button>
      ...
      {booking.type === 'HOTEL' ? (
        ...
        <div className="w-full max-w-5xl bg-white p-6 md:p-8 shadow-sm border border-gray-200 print:shadow-none print:border-none print:p-0 rounded-sm text-black box-border">
          {/* Header */}
