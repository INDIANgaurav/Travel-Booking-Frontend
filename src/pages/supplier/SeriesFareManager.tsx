    ...
    <div className="space-y-6">
                ...
                return (
                  <React.Fragment key={fare._id}>
                    <tr className={`hover:bg-blue-50/50 transition-colors ${isExpanded ? 'bg-blue-50/80 font-medium' : ''}`}>
                      ...
                      <td className="p-3 text-center">
                        <span className="inline-flex items-center gap-1 bg-[#f0f7ff] text-[#0b1031] px-2 py-0.5 rounded-md text-[10px] font-bold border border-[#0b1031]/20">
                          <UserCheck size={12} />
                          {fare.status}
                        </span>
                      </td>
                    ...
                    {isExpanded && (
                      <tr className="bg-[#f8fafc] border-b-2 border-[#0b1031]">
                        <td colSpan={13} className="p-5">
                          <div className="bg-white rounded-xl shadow-lg border border-[#0b1031]/20 overflow-hidden space-y-4 p-5">
                            {/* Card Header Summary */}
                            <div className="bg-[#f0f7ff] text-[#0b1031] p-4 rounded-lg flex items-center justify-between border border-[#0b1031]/20">
        ...
        <div className="fixed inset-0 bg-[#0b1031]/60 backdrop-blur-sm z-50 overflow-y-auto font-sans p-4 md:p-6 flex items-start justify-center">
          <div className="w-full max-w-6xl bg-white rounded-xl shadow-2xl border border-[#0b1031]/20 overflow-visible mb-12">
            ...
            <form onSubmit={handleCreateFare} className="p-8 space-y-8 text-xs text-gray-800">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button type="button" className="w-9 h-9 bg-[#0b1031] hover:bg-blue-900 text-white rounded-lg flex items-center justify-center shrink-0 shadow-sm transition-all" title="Add Another Date">
                              <Plus size={16} />
                            </button>
                          </div>
                          <label className="block text-[11px] font-bold text-gray-600 mb-1.5">Airline PNR*</label>
                          <input
                            type="text"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                        <div>
                          ...
                          <input
                            ...
                            required
                            className="w-full text-xs px-3 py-2 border border-gray-300 rounded-lg bg-white font-bold text-[#0b1031] focus:ring-2 focus:ring-[#1d6aa3] outline-none transition-all"
                          />
                        </div>
                        <div>
              ...
              <div className="bg-white border border-gray-200 shadow-sm rounded-xl overflow-hidden p-8">
                <div className="flex justify-between items-center mb-6 border-b border-gray-100 pb-3">
                  <div className="font-black text-sm text-[#0b1031] flex items-center gap-2">
                    <Check size={18} className="text-[#0b1031]" />
                    Flight Details
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-5 gap-4 items-end">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button type="button" className="w-9 h-9 bg-[#0b1031] hover:bg-blue-900 text-white rounded-lg flex items-center justify-center shrink-0 shadow-sm transition-all" title="Add another flight">
                            <Plus size={16} />
                          </button>
                        </div>
                      </div>
              ...
              <div className="bg-white border border-gray-200 shadow-sm rounded-xl overflow-hidden p-8">
                <div className="font-black text-sm text-[#0b1031] mb-6 flex items-center gap-2 border-b border-gray-100 pb-3">
                  <span className="text-[#0b1031] font-serif text-lg leading-none">₹</span>
                  Fare Details
                </div>
                <div className="space-y-8">
              ...
              <div className="text-right pt-4 border-t border-gray-200">
                ...
                <button
                  type="submit"
                  className="bg-[#0b1031] hover:bg-blue-900 text-white font-bold text-xs px-10 py-2.5 rounded-lg transition-all shadow-md"
                >
                  Submit
                </button>
              </div>
      ...
      {showBulkUploadModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 overflow-y-auto">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md my-8 overflow-hidden animate-[scaleIn_0.2s_ease-out]">
            ...
            <div className="p-6 space-y-6">
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 flex flex-col items-center justify-center text-center">
                ...
                <h3 className="font-bold text-[#0b1031] text-sm mb-1">Download Template</h3>
                <p className="text-xs text-gray-500 mb-4 px-4">
                  Please use our standard template to ensure all required fields are provided. Do not rename the columns.
                </p>
                <button 
                  onClick={downloadTemplate}
                  className="bg-white border border-blue-200 text-blue-600 font-bold text-xs px-6 py-2 rounded-lg shadow-sm hover:bg-blue-50 transition-colors flex items-center gap-2"
                >
              ...
              <div>
                <label className="block text-[11px] font-bold text-gray-700 mb-2">Upload Excel / CSV File *</label>
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 flex flex-col items-center justify-center hover:bg-gray-50 transition-colors">
                  <Upload size={24} className="text-gray-400 mb-2" />
                  <p className="text-xs text-gray-500 text-center mb-4">Drag and drop your file here, or click to browse</p>
                  <input 
                    type="file" 
                    accept=".xlsx, .xls, .csv" 
                ...
                {bulkFile && (
                  <div className="mt-3 p-3 bg-gray-50 rounded-lg flex justify-between items-center border border-gray-200">
                    <span className="text-xs font-bold text-gray-700 truncate pr-4">{bulkFile.name}</span>
              ...
              <div className="flex justify-end pt-4 border-t border-gray-100">
                <button
                  ...
                  className="bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-bold text-xs px-6 py-2 rounded-lg transition-all mr-3"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs px-8 py-2 rounded-lg transition-all shadow-md flex items-center gap-2 disabled:opacity-50"
                >
                  {bulkUploading ? (
